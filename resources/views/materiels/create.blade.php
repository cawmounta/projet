...
@endif
            ...
            <a  href="{{ route('materiels.index') }}"> </a>
     ...
     <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" style="height:150px" name="inventaire" placeholder="Inventaire"></textarea>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>Etat:</strong>
                <textarea class="form-control" style="height:150px" name="etat" placeholder="Etat"></textarea>
            </div>
        </div>
